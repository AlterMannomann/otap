...
# UNDER CONSTRUCTION
You may use the script [otap_package_update.sql](./setup/otap_package_update.sql) for usual updates. DBA install supports update and should be run accordingly before the package update to have the necessary grants [otap_dba_setup.sql] as SYSDBA. Updates in database structure will get announced.
### Current changes
