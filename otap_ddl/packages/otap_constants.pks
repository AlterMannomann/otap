...
AS
  ...
  */
  ...
  OTAP_USER_ROLE                   CONSTANT VARCHAR2(128 CHAR)  := '&OTAP_ROLE';
  OTAP_SCHEMA                      CONSTANT VARCHAR2(128 CHAR)  := '&OTAP_USER';
  OTAP_TABLESPACE                  CONSTANT VARCHAR2(128 CHAR)  := '&OTAP_TABLESPACE';
  ...
  OTAP_CFG_FN_HAS_PROCEDURE_TEMPLATE  CONSTANT CHAR(25)         := 'FN_HAS_PROCEDURE_TEMPLATE';
  ...
  OTAP_FN_HAS_PROCEDURE_TEMPLATE   CONSTANT CHAR(41)       := 'Procedure @proc@ exists (@procedureinfo@)';
