...
AS
  ...
  */
  ...
  /** FUNCTION otap_objects.otap_session_set_language
  ...
  */
  ...
  /** FUNCTION otap_objects.otap_session_get_language
  * Gets the current active session language id from OTAP_SESSION object.
  *
  * @param p_otap_session The current session_record from OTAP_TEST package.
  *
  * @return The current active session language id.
  *
  * @exception -20099 Internal error, invalid OTAP_SESSION object.
  */
