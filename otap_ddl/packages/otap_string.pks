...
AS
  ...
  * Constraints the border to a value between 2 and 10. Invalid border will be set to otap_constants.OTAP_BORDER_DEFAULT.
  *
  ...
  * to otap_constants.OTAP_REPORT_MIN_FILL_LENGTH or otap_constants.OTAP_REPORT_MAX_FILL_LENGTH,
  ...
  * will be set to otap_constants.OTAP_REPORT_MAX_FILL_LENGTH - (border size *2).
  *
  ...
  * column size. See otap_constants.OTAP_REPORT_MAX_FILL_LENGTH.
  *
  ...
  *
  * @return The minimum length of a decorated string with given title size and border fill, limited to otap_constants.OTAP_REPORT_MAX_FILL_LENGTH size.
  */
  ...
  * otap_constants.OTAP_REPORT_MAX_FILL_LENGTH.
  *
  ...
  * will translate to the default otap_constants.OTAP_RESULT_LAYOUT_DEFAULT.
