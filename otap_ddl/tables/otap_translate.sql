...
-- basic translation table, only one translation, one language supported currently, no user defined translation
-- any inserted translation is immediately active
