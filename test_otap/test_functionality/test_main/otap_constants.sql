...
BEGIN
  ...
  l_return := otap_test.is_eq(otap_constants.OTAP_INTERNAL_USER_ROLE, 'OTAP_USER', 'Verify package constant otap_constants.OTAP_INTERNAL_USER_ROLE');
  l_return := otap_test.is_eq(otap_constants.OTAP_INTERNAL_SCHEMA, 'OTAP', 'Verify package constant otap_constants.OTAP_INTERNAL_SCHEMA');
