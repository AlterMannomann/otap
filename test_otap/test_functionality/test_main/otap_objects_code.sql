...
BEGIN
  ...
  l_return := otap_objects.otap_session_set_test_set(RPAD('Oha', 300, 'a'), l_otap_session);
  ...
  l_return := otap_objects.otap_session_set_test_group(RPAD('Oha', 300, 'a'), l_otap_session);
  ...
  l_return := otap_objects.otap_session_set_test_name(RPAD('Oha', 300, 'a'), l_otap_session);
