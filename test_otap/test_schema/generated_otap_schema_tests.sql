...
-- LIKE scope: %
SELECT otap_test.set_test_group('trigger') FROM dual;
...
SELECT otap_test.has_procedure( p_procedure_name => 'DECORATE_BLANK'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_STRING'
                              , p_return_type => 'VARCHAR2'
...
SELECT otap_test.has_procedure( p_procedure_name => 'VALIDATE_TRANSLATION'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'PROCEDURE'
                              , p_package_name => 'OTAP_UTIL'
                              ) FROM dual;
...
SELECT otap_test.has_procedure( p_procedure_name => 'INTERVAL_SIZE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_UTIL'
                              , p_return_type => 'NUMBER'
...
SELECT otap_test.has_procedure( p_procedure_name => 'GET_SUMMARY_HEADER'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_REPORT'
                              , p_return_type => 'VARCHAR2'
...
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_SET_LANGUAGE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_GET_LANGUAGE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_GET_SCHEMA'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_NAME_PRECEDENCE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'BOOLEAN'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_INCLUDE_PACKAGES'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'BOOLEAN'
...
SELECT otap_test.has_procedure( p_procedure_name => 'OTAP_SESSION_TEST_SETUP'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_OBJECTS'
                              , p_return_type => 'OBJECT'
...
SELECT otap_test.has_procedure( p_procedure_name => 'GET_VERSION_INFO'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_API'
                              , p_return_type => 'VARCHAR2'
...
SELECT otap_test.has_procedure( p_procedure_name => 'TEST_ERROR'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_API'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'TEST_ERROR_CHECK'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_API'
                              , p_return_type => 'VARCHAR2'
...
SELECT otap_test.has_procedure( p_procedure_name => 'SET_LANGUAGE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_TEST'
                              , p_return_type => 'VARCHAR2'
...
SELECT otap_test.has_procedure( p_procedure_name => 'GET_LANGUAGE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_TEST'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'GET_SCHEMA'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_TEST'
                              , p_return_type => 'VARCHAR2'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'NAME_PRECEDENCE'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_TEST'
                              , p_return_type => 'BOOLEAN'
                              ) FROM dual;
SELECT otap_test.has_procedure( p_procedure_name => 'INCLUDE_PACKAGES'
                              , p_schema => 'OTAP'
                              , p_procedure_type => 'FUNCTION'
                              , p_package_name => 'OTAP_TEST'
                              , p_return_type => 'BOOLEAN'
